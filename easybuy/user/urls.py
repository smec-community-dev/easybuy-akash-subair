...
urlpatterns = [
    ...
    path("category/<int:id>/",views.category_products,name="category_products_by_id_user"),
    path("subcategory/<int:id>/",views.subcategory_products,name="subcategory_products_by_id_user"),
    path("category/<slug:slug>/", views.category_products, name="category_products_user"),
    path("subcategory/<slug:slug>/",views.subcategory_products,name="subcategory_products_user"),
